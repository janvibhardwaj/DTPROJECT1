...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <li style="float: right"><a href="../Cart" class="w3-hover-none w3-text-sand w3-hover-text-white"><b>MyCart </b>
...
<table class="table table-condensed">
 ...
 <c:forEach items="${itemsList}" var="itemObj">
  		...
  		<tr>
  			<td></td>
  			<td></td>
  			<td><a href="${contextRoot}/makePayment" class="btn btn-primary">Go To Cart</a></td>
  			<td><a href="${contextRoot}/confirmOrder" class="btn btn-primary">Confirm Order</a></td>
  		</tr>
  </tbody>
</table>
